...
import nurtia.data.directFractals.MandelbrotContour
...
object MandelbrotData extends Data[Mandelbrot.Sequence] {
  ...
  val selectionFractals: Seq[(String, ContentFunction[Double])] = Seq(
    "RoughColoring(150)"         -> Mandelbrot(150, 10d)   ~> RoughColoring.double(),
    "RoughColoring(250)"         -> Mandelbrot(250, 10d)   ~> RoughColoring.double(),
    "RoughColoring(500)"         -> Mandelbrot(500, 10d)   ~> RoughColoring.double(),
    "RoughColoring(750)"         -> Mandelbrot(750, 10d)   ~> RoughColoring.double(),
    "RoughColoring(1500)"        -> Mandelbrot(1500, 10d)  ~> RoughColoring.double(),
    "SmoothColoring(500)"        -> Mandelbrot(500, 10d)   ~> SmoothColoring(),
    "OrbitPoint(250, 0, 0)"      -> Mandelbrot(250, 10d)   ~> OrbitPoint(0, 0),
    ...
    "CardioidNumeric(250, 20)"   -> Mandelbrot(250, 10d)   ~> CardioidNumeric(20),
    "CardioidHeuristic(250, 20)" -> Mandelbrot(250, 10d)   ~> CardioidHeuristic(20),
    "BiggestStep(250)"           -> Mandelbrot(250, 10d)   ~> BiggestStep(),
    "SmallestStep(250)"          -> Mandelbrot(250, 100d) ~> SmallestStep()
  )
