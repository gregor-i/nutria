...
trait ContentFactory extends ((Viewport, Dimensions, Fractal, Color[Double]) => Image[Double])

case object SimpleFactory extends ContentFactory {
  def apply(view: Viewport, dim: Dimensions, fractal: Fractal, color:Color[Double]) =
