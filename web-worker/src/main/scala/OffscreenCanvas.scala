// copy pasted from https://github.com/workingDog/WebvrScala/blob/master/src/main/scala/com/kodekutters/webvr/OffscreenCanvas.scala
...
class OffscreenCanvas(width: Int, height: Int) extends js.Object {
  ...
  /** The OffscreenCanvas.toBlob() method creates a Blob object representing the image contained in the canvas
    ...
    */
  def convertToBlob(`type`: Option[String], encoderOptions: js.Any*): Promise[Blob] = js.native
